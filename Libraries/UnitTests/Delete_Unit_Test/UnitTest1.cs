     ...
     private Mock<IAlmacenDataContext> ConfigurarMockDbContext()
{
   ...
   new Material
    ...
    public void Test_Delete_Order_Succesful()
    {
        var mockDbContext = ConfigurarMockDbContext();
        int id=1;
        int ACT=CrudFuntions.DeleteOrdersTest(id,mockDbContext.Object);
        int EXP=0;
        Assert.Equal(EXP,ACT);
    }
    [Fact]
    ...
    public void Test_Delete_Teacher_Succesful()
    {
        var mockDbContext = ConfigurarMockDbContext();
        int id=0;
        int ACT=CrudFuntions.DeleteTeachersTest(id,mockDbContext.Object);
        int EXP=-1;
        Assert.Equal(EXP,ACT);
    }
    [Fact]
    ...
    public void Test_Delete_Manager_Succesful()
    {
        var mockDbContext = ConfigurarMockDbContext();
        int id=1;
        int ACT=CrudFuntions.DeleteInventoryManagerTest(id,mockDbContext.Object);
        int EXP=0;
        Assert.Equal(EXP,ACT);
    }
    [Fact]
    ...
    public void Test_Delete_Student_Succesful()
    {
        var mockDbContext = ConfigurarMockDbContext();
        int id=1;
        int ACT=CrudFuntions.DeleteStudentsTest(id,mockDbContext.Object);
        int EXP=0;
        Assert.Equal(EXP,ACT);
    }
    [Fact]
    ...
    public void Test_Delete_Mant_Succesful()
    {
        var mockDbContext = ConfigurarMockDbContext();
        int id=1;
        int ACT=CrudFuntions.DeleteMantTest(id,mockDbContext.Object);
        int EXP=0;
        Assert.Equal(EXP,ACT);
    }
    [Fact]
