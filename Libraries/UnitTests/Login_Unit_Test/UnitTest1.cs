        ...
        var usuarios = new List<Usuario>
{
    ...
    public void NoPasswordSent()
    {
        ...
        var (usuario, tipoUsuario) = UI.LogInTest("Jared", "", mockDbContext.Object);
        int EXP = 0;
    ...
    public void NoUserSent()
    {
        ...
        string user="Jared";
        // When
        var (usuarioEncontrado, MenuCorrespondiente)=UI.LogInTest(user,Password,mockDbContext.Object);
        int EXP=0;
        // Then
