    ...
    private Mock<IAlmacenDataContext> ConfigurarMockDbContext()
{
        ...
        var usuario=  new Usuario
    {
        ...
        bool ACT=CrudFuntions.AddStudent(nuevoEstudiante,usuario,mockDbContext.Object);
        Assert.True(ACT);
    }
        ...
        var usuario=  new Usuario
    {
        ...
        bool ACT=CrudFuntions.AddTeacher( nuevoDocente,usuario,mockDbContext.Object);
        Assert.False(ACT);
    }
    ...
    bool ACT=CrudFuntions.AddWarehouseManager( nuevoAlmacenista,usuario,mockDbContext.Object);
    Assert.False(ACT);
